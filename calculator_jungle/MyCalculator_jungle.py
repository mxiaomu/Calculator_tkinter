...
class MyCalculator():
    ...
    def set_label(self):
        ...
        result_label1 = tkinter.Label(self.top_frame, font=('微软雅黑', 25), bg='#2B5E62', bd='9', fg='#FFFEFF', anchor='se',
                              textvariable=self.result_panel1)
        result_label1.place(width=450, height=100)
        result_label2 = tkinter.Label(self.top_frame,font=('微软雅黑', 30), bg='#2B5E62', bd='9', fg='#75ABB1', anchor='se',
    ...
    def set_span(self):
        ...
        button_c = tkinter.Button(self.bootom_frame, text='C', bd='1', font=('微软雅黑', 20), bg='#D2EDEE',
                                  fg='#4DA9AB', command=lambda: self.pressC())
        button_c.place(x=0, y=0, width=90, height=80)

        button_back = tkinter.Button(self.bootom_frame, text='<-', bd='1', font=('微软雅黑', 20), bg='#FFFEFF',
                                     fg='#4DA9AB', command=lambda: self.pressBack())
        button_back.place(x=90, y=0, width=90, height=80)

        button_minus = tkinter.Button(self.bootom_frame, text='±', bd='1', font=('微软雅黑', 20), bg='#FFFEFF',
                                      fg='#4DA9AB', command=lambda: self.pressMinus())
        button_minus.place(x=180, y=0, width=90, height=80)

        button_left = tkinter.Button(self.bootom_frame, text='(', bd='1', font=('微软雅黑', 20), bg='#FFFEFF',
                                     fg='#4DA9AB', command=lambda: self.pressLeft())
        button_left.place(x=270, y=0, width=90, height=80)

        button_right = tkinter.Button(self.bootom_frame, text=')', bd='1', font=('微软雅黑', 20), bg='#FFFEFF',
                                      fg='#4DA9AB', command=lambda: self.pressRight())
        button_right.place(x=360, y=0, width=90, height=80)

        button_1 = tkinter.Button(self.bootom_frame, text='1', bd='1', font=('微软雅黑', 20), bg='#FFFEFF',
                                  fg='#2B5E62', command=lambda: self.pressNum('1'))
        button_1.place(x=0, y=80, width=90, height=80)

        button_2 = tkinter.Button(self.bootom_frame, text='2', bd='1', font=('微软雅黑', 20), bg='#FFFEFF',
                                  fg='#2B5E62', command=lambda: self.pressNum('2'))
        button_2.place(x=90, y=80, width=90, height=80)

        button_3 = tkinter.Button(self.bootom_frame, text='3', bd='1', font=('微软雅黑', 20), bg='#FFFEFF',
                                  fg='#2B5E62', command=lambda: self.pressNum('3'))
        button_3.place(x=180, y=80, width=90, height=80)

        button_power = tkinter.Button(self.bootom_frame, text='^', bd='1', font=('微软雅黑', 20), bg='#FFFEFF',
                                      fg='#4DA9AB', command=lambda: self.pressOperation('^'))
        button_power.place(x=270, y=80, width=90, height=80)

        button_remainder = tkinter.Button(self.bootom_frame, text='%', bd='1', font=('微软雅黑', 20), bg='#FFFEFF',
                                          fg='#4DA9AB', command=lambda: self.pressOperation('%'))
        button_remainder.place(x=360, y=80, width=90, height=80)

        button_4 = tkinter.Button(self.bootom_frame, text='4', bd='1', font=('微软雅黑', 20), bg='#FFFEFF',
                                  fg='#2B5E62', command=lambda: self.pressNum('4'))
        button_4.place(x=0, y=160, width=90, height=80)

        button_5 = tkinter.Button(self.bootom_frame, text='5', bd='1', font=('微软雅黑', 20), bg='#FFFEFF',
                                  fg='#2B5E62', command=lambda: self.pressNum('5'))
        button_5.place(x=90, y=160, width=90, height=80)

        button_6 = tkinter.Button(self.bootom_frame, text='6', bd='1', font=('微软雅黑', 20), bg='#FFFEFF',
                                  fg='#2B5E62', command=lambda: self.pressNum('6'))
        button_6.place(x=180, y=160, width=90, height=80)

        button_plus = tkinter.Button(self.bootom_frame, text='+', bd='1', font=('微软雅黑', 20), bg='#FFFEFF',
                                     fg='#4DA9AB', command=lambda: self.pressOperation('+'))
        button_plus.place(x=270, y=160, width=90, height=80)

        button_sub = tkinter.Button(self.bootom_frame, text='-', bd='1', font=('微软雅黑', 20), bg='#FFFEFF',
                                    fg='#4DA9AB', command=lambda: self.pressOperation('-'))
        button_sub.place(x=360, y=160, width=90, height=80)

        button_7 = tkinter.Button(self.bootom_frame, text='7', bd='1', font=('微软雅黑', 20), bg='#FFFEFF',
                                  fg='#2B5E62', command=lambda: self.pressNum('7'))
        button_7.place(x=0, y=240, width=90, height=80)

        button_8 = tkinter.Button(self.bootom_frame, text='8', bd='1', font=('微软雅黑', 20), bg='#FFFEFF',
                                  fg='#2B5E62', command=lambda: self.pressNum('8'))
        button_8.place(x=90, y=240, width=90, height=80)

        button_9 = tkinter.Button(self.bootom_frame, text='9', bd='1', font=('微软雅黑', 20), bg='#FFFEFF',
                                  fg='#2B5E62', command=lambda: self.pressNum('9'))
        button_9.place(x=180, y=240, width=90, height=80)

        button_mul = tkinter.Button(self.bootom_frame, text='×', bd='1', font=('微软雅黑', 20), bg='#FFFEFF',
                                    fg='#4DA9AB', command=lambda: self.pressOperation('*'))
        button_mul.place(x=270, y=240, width=90, height=80)

        button_div = tkinter.Button(self.bootom_frame, text='÷', bd='1', font=('微软雅黑', 20), bg='#FFFEFF',
                                    fg='#4DA9AB', command=lambda: self.pressOperation('/'))
        button_div.place(x=360, y=240, width=90, height=80)

        button_0 = tkinter.Button(self.bootom_frame, text='0', bd='1', font=('微软雅黑', 20), bg='#FFFEFF',
                                  fg='#2B5E62', command=lambda: self.pressNum('0'))
        button_0.place(x=90, y=320, width=90, height=80)

        button_point = tkinter.Button(self.bootom_frame, text='.', bd='1', font=('微软雅黑', 20), bg='#FFFEFF',
                                      fg='#2B5E62', command=lambda: self.pressNum('.'))
        button_point.place(x=180, y=320, width=90, height=80)

        button_eq = tkinter.Button(self.bootom_frame, text='=', bd='1', font=('微软雅黑', 20), bg='#4CA8AC',
                                   fg='#F1F1F1', command=lambda: self.pressEqual())
        button_eq.place(x=270, y=320, width=180, height=80)

        button_jump = tkinter.Button(self.bootom_frame, text='特殊', bd='1', font=('微软雅黑', 20), bg='#FFFEFF',
                                     fg='#2B5E62', command=lambda: self.Cover())
    ...
    def Cover(self):
        ...
        button_jump = tkinter.Button(self.bootom_frame, text='普通', bd='1', font=('微软雅黑', 20), bg='#FFFFFF',
                                     fg='#2B5E62', command=lambda: self.Commer())
        button_jump.place(x=0, y=320, width=90, height=80)

        button_sin = tkinter.Button(self.bootom_frame, text='sin(x)', bd='1', font=('微软雅黑', 20), bg='#FFFFFF',
                                    fg='#2B5E62', command=lambda: self.pressSin())
        button_sin.place(x=0, y=400, width=90, height=80)

        button_cos = tkinter.Button(self.bootom_frame, text='cos(x)', bd='1', font=('微软雅黑', 20), bg='#FFFFFF',
                                    fg='#2B5E62', command=lambda: self.pressCos())
        button_cos.place(x=90, y=400, width=90, height=80)

        button_tan = tkinter.Button(self.bootom_frame, text='tan(x)', bd='1', font=('微软雅黑', 20), bg='#FFFFFF',
                                    fg='#2B5E62', command=lambda: self.pressTan())
        button_tan.place(x=180, y=400, width=90, height=80)

        button_ds = tkinter.Button(self.bootom_frame, text='1/x', bd='1', font=('微软雅黑', 20), bg='#FFFFFF',
                                   fg='#2B5E62', command=lambda: self.pressFractal())
        button_ds.place(x=270, y=400, width=90, height=80)

        button_sl = tkinter.Button(self.bootom_frame, text='√x', bd='1', font=('微软雅黑', 20), bg='#FFFFFF',
                                   fg='#2B5E62', command=lambda: self.pressSqrt())
        button_sl.place(x=360, y=400, width=90, height=80)

    def Commer(self):
        root.minsize(height=600, width=450)
        button_jump = tkinter.Button(self.bootom_frame, text='特殊', bd='1', font=('微软雅黑', 20), bg='#FFFFFF',
                                     fg='#2B5E62', command=lambda: self.Cover())
        button_jump.place(x=0, y=320, width=90, height=80)

if __name__ == '__main__':
    calculator = MyCalculator(450, 600, '丛林')
