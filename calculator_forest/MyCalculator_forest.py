...
class MyCalculator():
    ...
    def set_label(self):
        ...
        result_label2 = tkinter.Label(self.top_frame,font=('微软雅黑', 25), bg='#FFFEFF', bd='9', fg='#000000', anchor='se',
    ...
    def set_span(self):
        ...
        button_jump = tkinter.Button(self.bootom_frame, text='特殊', bd='0', font=('微软雅黑', 20), bg='#429488',
    ...
    def Cover(self):
        ...
        button_jump = tkinter.Button(self.bootom_frame, text='普通', bd='0', font=('微软雅黑', 20), bg='#429488',
                                     fg='#FFFEFF', command=lambda: self.Commer())
        button_jump.place(x=0, y=320, width=90, height=80)

        button_sin = tkinter.Button(self.bootom_frame, text='sin(x)', bd='0', font=('微软雅黑', 20), bg='#429488',
                               fg='#FFFEFF',command=lambda: self.pressSin())
        button_sin.place(x=0, y=400, width=90, height=80)

        button_cos = tkinter.Button(self.bootom_frame, text='cos(x)', bd='0', font=('微软雅黑', 20), bg='#429488',
                                     fg='#FFFEFF',command=lambda: self.pressCos())
        button_cos.place(x=90, y=400, width=90, height=80)

        button_tan = tkinter.Button(self.bootom_frame, text='tan(x)', bd='0', font=('微软雅黑', 20), bg='#429488',
                                   fg='#FFFEFF',command=lambda: self.pressTan())
        button_tan.place(x=180, y=400, width=90, height=80)

        button_ds = tkinter.Button(self.bootom_frame, text='1/x', bd='0', font=('微软雅黑', 20), bg='#429488',
                                   fg='#FFFEFF',command=lambda: self.pressFractal())
        button_ds.place(x=270, y=400, width=90, height=80)

        button_sl = tkinter.Button(self.bootom_frame, text='√x', bd='0', font=('微软雅黑', 20), bg='#429488',
